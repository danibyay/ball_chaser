...
// callback function that executes when drive_bot service is requested
...
int main(int argc, char** argv)
{
    ...
    // Define a drive /ball_chaser/command_robot service with
    // a handle_drive_request callback function
    service = n.advertiseService("/ball_chaser/command_robot", handle_drive_bot_request);
